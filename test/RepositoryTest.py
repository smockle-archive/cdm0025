...
class RepositoryTest(unittest.TestCase):
    ...
    def testDetermineRelativeSizes(self):
        ...
        # are added (a medium non-empty repository). [2, 5, 10, 20, 44] is
        # returned.
        ...
        self.assertEqual(relativeSizes[0], 2)
        self.assertEqual(relativeSizes[1], 5)
        self.assertEqual(relativeSizes[2], 10)
        self.assertEqual(relativeSizes[3], 20)
        self.assertEqual(relativeSizes[4], 44)
